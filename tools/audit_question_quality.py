...
BANNED_PATTERNS = [
    ...
    "en uygun kisa bilgi",
    "oynanirken amac",
    "sahadaki temel oyuncu sayisi",
    "sahadaki takim oyuncu sayisi",
    "takiminda sahadaki",
    "denince akla gelen temel ekipman",
    "bilgisi sorulursa",
    "hangi oyun unsurudur",
    "hangi baglamda kullanilir",
    "karsiligi hangisidir",
    "eslesmesi hangisidir",
    "analizi hangisidir",
    "siralamasi hangisidir",
    "yanlis olmayan",
    "ayirt edici terim",
    "musabaka yapisi",
    "kurala en yakin",
